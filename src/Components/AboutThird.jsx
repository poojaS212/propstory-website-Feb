      ...
      >
        <div className="max-w-7xl mx-auto h-full grid grid-cols-1 lg:grid-cols-12 gap-12 py-24">
          ...
          <div className="lg:col-span-12 bg-blue-950 md:ml-[10%] ml-0 ms-0 rounded-tr-[8rem]">
            <p className="md:py-26 md:px-20 leading-[2.5rem] text-2xl">Founded in 2015, PropStory has grown into a high ROI-driven, preferred digital marketing partner for many of India’s best-known and well-respected real estate brands.
